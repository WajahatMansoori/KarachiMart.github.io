...
namespace WebApplication8.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        {
            var orderDetails = db.OrderDetails.Include(o => o.OrderTable).Include(o => o.Product);
        ...
        {
            ViewBag.OrdID_FK = new SelectList(db.OrderTables, "Ord_Id", "Ord_Id");
            ViewBag.ProID_FK = new SelectList(db.Products, "P_Id", "P_Name");
            return View();
        }
